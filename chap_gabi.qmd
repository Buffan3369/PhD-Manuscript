...
Authors: Lucas Buffan¹*, Fabien L. Condamine¹, Philip B. Holden², Sara Varela³
...
In addition, successful simulations starting from North America generally started from an ancestor located closer to the isthmus of Panama than those starting from South America (@fig-metrics C), again except for simulation generated under $M3$. Also, we can highlight a general trend that ancestral species originated closer to the isthmus in the case of successful simulations compared to unsuccessful ones ([@fig-s7]--[-@fig-s8]). Interestingly enough, the results obtained for this metric, just like those obtained for the other two, hold for simulations generated after standardising the initial distances to the isthmus of North American virtual species with those starting from South America (@fig-s4).
