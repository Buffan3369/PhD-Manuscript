...
The last chapter of this PhD thesis is framed around a long-standing question in evolutionary biology: the drivers behind the asymmetry observed during the late Neogene faunal exchange between North and South America, commonly referred to as the Great American Biotic Interchange (GABI). Why North American lineages colonised the South with an undoubtedly larger success than the other way around in the aftermath of the GABI has indeed long puzzled evolutionary biologists [*e*.*g*., @simpson1980; @webb1976; @marshall1982]. Meanwhile some assumed that such an asymmetry emerged from the competitive superiority of North American mammals over South Americans [*e*.*g*., @simpson1950] or a predatory regime disequilibrium between the two continents [*e*.*g*., @faurby_asymmetry_2016], others emphasised that this asymmetry most likely arose as a result from palaeoclimate dynamics [*e*.*g*., @webb1991; @vrba1992]. Using mechanistic eco-evolutionary simulations, a powerful framework to test for the factors at play to shape the emergence and the dynamics of biodiversity patterns without being impacted by biases present in empirical data [*e*.*g*., @hagen2023], this chapter causally assesses the latter family of hypotheses, *i*.*e*., palaeoclimate-dependent asymmetry. This represent the first attempt to derive the mechanisms behind the GABI by means of eco-evolutionary simulations.
