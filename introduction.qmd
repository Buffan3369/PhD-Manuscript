...
Just like any other fields of evolutionary biology [@simpson1944], studying macroevolution is a matter of tempo (*i*.*e*., the rate at which macroevolutionary changes occur, namely, speciation, extinction or morphological evolution rates) mode (*i*.*e*., the forces underlying these changes) [@saupe2021].

### Tempo of Macroevolution: how do rates change across time? {#sec-MacroTempo}

The temporal dynamics of diversification rates rule how clades' diversity change across evolutionary times (@sec-TempHetero). As
...
Due to its unique physical geography, South America offers an immense diversity of habitats, from tropical alluvial plains, dry highlands, grasslands to the top of the second highest mountains on Earth (@fig-physiography). Understanding the build-up of South American landscapes is vital to disentangle the build-up of South America's astonishing biodiversity.
