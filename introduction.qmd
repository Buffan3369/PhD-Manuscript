...
Several caveats apply to the study of biodiversity patterns 'from a distance', the baseline of the macroecological perspective [@diniz-filho2023]. Some of them are grouped into what is known as the 'biodiversity shortfalls', representing inherent limitations related to missing information in biodiversity data, thereby inevitably hampering accurate understanding of the modelled eco-evolutionary processes. Three biodiversity shortfalls are usually considered, though @hortal2015 in fact more finely discriminated seven shortfalls -- that will not be extensively covered here. These three shortfalls have been named after three renowed figures of ecology, evolution and systematics. 

The Linnean shortfall reflects to the taxonomic uncertainty, that is, the degree of certainty that one may have, after sampling two individuals at random in a community, to tell whether they belong to the same species or to two distinct species. Next, the Wallacean shortfall refers to the knowledge gaps in species distribution, *i*.*e*., the fact that a species may be somewhere where we did not observe it; thus this place in particular would be excluded from upstream range map reconstructions of that species (sort of type-1 error applied to biodiversity data). Last, the Darwinian shortfall refers to the lack of knowledge of the evolutionary relationships between species.



### Propagation of the caveats of the fossil record when studying biodiversity through time {#sec-FossilBias}

When considering fossil data, the previously described biodiversity shortfalls take a new dimension.
...
### First stratum: endemic radiations (Late Cretaceous--middle Eocene) {#sec-strat1}
...
Along with these therian lineages of North American affinity, non-therian lineages persisted in South America at least until the mid-Palaeogene, thus well after the Cretaceous--Palaeogene boundary [@goin_gondwana_2012]. The most extreme example of non-therian lineage persistence known to date is probably best exemplified by the enigmatic *Necrolestes*, from the Santa Cruz Formation (early Miocene, Santacrucian SALMA, see @fig-SALMA), identified as a remnant of the clade Meridiolestida, a mammal group that thrived from the Late Jurassic up until the Late Cretaceous [@rougier2012; @chimento2012].
...
### Third stratum: Inter-american exchange, massive faunal disruptions, and establishment of the extant mammal biodiversity (latest Miocene--Present) {#sec-strat3}
