...
Simpson's first stratum characterises the early phase of South American mammal evolution in the aftermath of the continent's isolation. It is thought to have lasted from the Late Cretaceous/early Palaeocene to the late middle Eocene. Mammal at that time are often referred to as the continent's 'original inhabitants'. These would include endemic metatherians (@fig-metatheria), native ungulates (@fig-SANUs), xenarthrans (@fig-Xenarthra), as well as a few remnant non-therian lineages (*e*.*g*., Gondwanatheria).
...
### Second stratum: Trans-atlantic migrations and faunal 'modernisation' (late Eocene--Late Miocene) {#sec-strat2}

Most specialists agree that major re-organisations occurred within South American mammal assemblages near the Eocene--Oligocene boundary (that will be more thoroughly covered in \textcolor{Blue}{Chapter 1}), marking the onset of Simpson's second faunal stratum. Two main aspects mark the distinction between this second stratum and the previous one: (1) the morphological 'modernisation' that occurred among "original inhabitant" faunas, alongside the notable extinction of many basal SANU and metatherian clades (as well as the latest non-therian remnants) and (2) the arrival and radiation of rodents and primates in South America, most likely from Afro-asian ancestors.

The aforementioned faunal 'modernisation' had two compounds: (1) emergence of morphological innovations among 'original inhabitants', likely boosting higher-level taxonomic origination, and (2) extinction of basal, 'archaic' lineages. The most notable morphological innovation that could be mentionned is probably the increase in cheek teeth crown height (*i*.*e*., hypsodonty), occurring independently among several (at least six) groups of native ungulates from the middle Eocene onwards [@croft2020]. The evolution towards hypsodonty in South America is particularly interesting as hypsodont cheek teeth started to be recorded in assemblages 20 million years older than the first reports of hypsodonty outside South America [@stebbins1981]. As they diversified, rodents (see later in this section) also rapidly acquired hypsodont cheek teeth, again, way before any other place in the world (late Oligocene--Early Miocene), as it shows in the superfamily Chinchilloidea [*e*.*g*., @arnal2026; @croft2021; @marivaux_early_2020; @wood1959] -- see \textcolor{Blue}{Chapter 2}.

By analysing two early Oligocene metatherian communities from Southern South America (one of Tinguirican age, the other being the La Cantera fauna, see @fig-SALMA), @goin2010 reported an important taxonomic turnover occurring among metatherians in the few million years that followed the Eocene--Oligocene transition (EOT). This geological boundary, that will be explored in further details in \textcolor{Blue}{Chapter 1}, has been identified as the most intense Cenozoic climatic disruption as global temperature cooled down by several degrees in a few hundred thousands of years [@coxall2007; @liu2009; @westerhold2020]. The EOT was related to a major faunal turnover among Northern hemisphere mammalian communities [@meng1998; @stehlin1909; @stucky2014]. As an echo to the french expression 'Grande Coupure' [@stehlin1909] used to characterise the mammalian turnover that occurred among European mammal assemblages, @goin2010 thus derived the expression 'Bisagra Patagónica' (Patagonian hinge) to qualify the faunal turnover that they characterised.

A recent quantitative study suggested that the diversification of rodents and primates negatively affected the diversity of the endemic groups [@pino].

### Third stratum: Inter-american exchange, massive faunal disruption, and establishment of the extant mammal biodiversity (latest Miocene--Present) {#sec-strat3}
