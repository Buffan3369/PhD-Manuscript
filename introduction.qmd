...
#| label: fig-MapLoc
#| out-width: 15cm
#| fig-cap: Distribution of the South American mammal fossil record across geological epochs (Holocene excluded), on top of the continent's present-day topography [@boschman2021]. Several keystone localities have been highlighted.
...
Striking unevenness of the fossil record @ugarte2025. This unevenness is spatial (@fig-MapLoc)  and temporal (fig-SALMA)

Difficulty to sample. 

Colonisation palaeontology.

The South American Land Mammal Ages (SALMA) system: between gaps and uncertainties

South American mammal fossil record paradox: there is almost an inverse gradient in extant mammal diversity [@fig-maps] and the abundancy of fossil remains across the continent, mostly concentrated within Southern South American plains [@fig-MapLoc].
