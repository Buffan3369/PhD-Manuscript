...
Beyond its spatial organisation into units of shared taxonomic composition, biodiversity also exhibits a striking latitudinal organisation, in which species richness increases with decreasing latitude, known as the Latitudinal Biodiversity Gradient (LBG). Humboldt already noted that plant species richness changed across latitude. According to him, low-latitude tropical assemblages would be essentially made up with a large number of different species per unit of area, each having a relatively low density ("isolated and sparse"). Conversely, higher-latitude temperate or cold assemblages would be characterised by a substantially lower species richness per unit of area, with a single dominant species being over-represented, sort of "excluding \[...\] heterogeneous species" [@humboldt1807].
LBG raised by Humboldt or Wallace, and first quantified by @fischer1960. @hillebrand2004 produced a meta-analysis of 600 different studies and illustrated the consistency of the decrease in species richness with increasing latitude characterising the LBG

Hence, biodiversity is largely heterogeneous across space, raising general questions that have been thoroughly investigated in the past, as to 'Why are there more species in the tropics than in the poles?' 'What constraints the distribution of species on our planet?'
...
## South America across the Cenozoic: geographical and environmental context
...
Due to its astonishing diversity mostly unknown to Europeans at the time South America has almost acted as an 'obligate step'

### History of mammal palaeontology in South America: a brief overview

Paul Gervais?

South American mammal palaeontology sadly started as a colonisation by-product, as European explorators plundered Patagonian soils, intrigued by skeletal remains trapped in the rocks. In the late 18$^{th}$ century, some of the South American fossils (essentially from the Southern South American plains) brought back to Europe provoked curiosity among the leading figures of the emerging field of comparative anatomy. As a result, in 1796, Georges Cuvier described the famous *Megatherium americanum*, and proposed this six-meter-beast to be a sloth. A few decades later, in 1836, Charles Darwin, back from his five-years journey on board the HMS Beagle building a geological and naturalistic inventory in South America, brought back to England a wealth of fossil material (in particular from the region of Punta Alta, Patagonia). These fossil remains were given to the renowed palaeontologist Richard Owen, who described, in 1837, many emblematic fossil mammals from South America, including the car-sized armadillo *Glyptodon*, the giant sloth *Mylodon*, the giant camel-like native ungulate *Macrauchenia* or the rhino-sized native ungulate *Toxodon*.

The second half of the 19$^{th}$ century marked the beginning of South American mammal palaeontology made by scientists from South America, notably with the thorough and cornerstone labour of Florentino Ameghino. This Argentinian palaeontologist, born in Italy, produced a remarkable quantity of work relying on fossil material collected by his brother, Carlos Ameghino, who carried out most of the field expeditions that fed Florentino Ameghino's collections. Florentino Ameghino's written productions are regarded as essential building-blocks for South American palaeomammalogy. These are probably best exemplified by the foundational monography "*Contribución al conocimiento de los mammíferos fósiles de la República Argentina*" (1889), where several hundreds of taxa from the Argentinian fossil record are described, many of them still considered as valid species. The beginning of the 1910s saw the rise of another greatly recognised Argentinian figure of South American mammal palaeontology: Lucas Kraglievich. Kraglievich conducted key field expeditions in Patagonia. The material he collected led him to produce major contirubutions to the knowledge of the evolution of xenarthrans, caviomorphs and native ungulates.

South American mammal palaeontology long remained essentially constrained to Argentina, as it shows on the map of the distribution of fossil mammal-bearing localities on the continent (see @sec-PalChal and Figure X).

Apart from Argentina, Brazil in the 1950s (Carlos de Paula Couto).
...
*Map SA with Punta Alta + bones in question?*

@simpson1980 wrote that South American mammal assemblages across the Cenozoic were best summarised by three successive temporal strata.

### First stratum: endemic radiations (late Cretaceous--middle Eocene)

Xenarthrans, metatherians, SANUs
...
Striking unevenness of the fossil record @ugarte2025. This unevenness is spatial (map of occ) and temporal (important temporal gaps persist in the fossil record of SAM, display SALMA scale). Difficulty to sample. Colonisation palaeontology.
